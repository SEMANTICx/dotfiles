...
vim.opt.colorcolumn = "" -- Disable fixed column marker
vim.opt.showmatch = true -- Highlight matching brackets
vim.opt.matchtime = 2 -- How long to show matching bracket
vim.opt.ruler = false -- Keep the command line visually clear on the dashboard
vim.opt.showcmd = false -- Avoid right-side command echoes sharing the cmdline row
vim.opt.completeopt = "menuone,noinsert,noselect" -- Completion options
vim.opt.showmode = false -- Don't show mode in command line
vim.opt.pumheight = 10 -- Popup menu height
vim.opt.pumblend = 10 -- Popup menu transparency
vim.opt.winblend = 0 -- Floating window transparency
vim.opt.winborder = "rounded" -- Use consistent rounded borders for floating windows
...
vim.opt.swapfile = true -- Keep crash recovery for normal file buffers
...
vim.opt.guicursor = {
	...
	"i-ci-ve:ver40", -- Insert, Command-line Insert, Visual-exclusive
...
-- Split Behavior
vim.opt.laststatus = 3 -- Global statusline keeps edge panels stable
vim.opt.splitkeep = "screen" -- Keep text stable when opening edge panels
